...
import { ChevronUp, ChevronDown, History, Award } from "lucide-react";
...
export default function DoubleGame({ autorizacao_cassino, id_jogador }) {
  ...
  useEffect(() => {
    ...
    socketRef.current = io("https://766b-45-160-89-106.ngrok-free.app", {
  ...
  const placeBet = (color) => {
    ...
    setTimeout(() => {
      socketRef.current.emit("double:bet", {
        ...
        cassino_url_callback: "https://766b-45-160-89-106.ngrok-free.app/api/atualizar-saldo",
      });
    }, 300);
  };
    ...
    <>
      <div className="max-w-4xl mx-auto  flex justify-center items-center">
        <div className="flex flex-col md:flex-row gap-6  justify-center">
          {/* Game section */}
          <div className="w-full md:w-3/4 bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
